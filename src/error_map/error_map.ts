...
errorReferenceMap.set(201,
	"201|Bracket Error: too much brackets has been closed or has been closed before a bracket were opened.");
errorReferenceMap.set(202,
	"202|Missing Statement Error: It seems, you forgot some statements inside your logic expression.");
errorReferenceMap.set(203,
	"203|Missing Statement Error: It seems, you forgot to add a statement at the end of your logic expression.");
errorReferenceMap.set(204,
	"204|Missing Connector Error: It seems, you forgot some connector between your statements inside your logic "
	+ "expression.");
